...
class App extends React.Component {
        ...
        <header className="">
          <div className="d-flex justify-content-between align-items-center py-3 border-bottom">
            <div className="logo d-flex align-items-end text-reset text-decoration-none">
              <span role="button" className="text-reset text-decoration-none">
              ...
              <div className="justify-content-center">
                <Nav activeKey={this.props.active} onSelect={(e) => this.props.setActive(e)}>
                  <div className="nav-item pe-2 border-end">
                    <a href="https://explorer.shido-observer.com" target="_blank" rel="noopener noreferrer" className="nav-link">
                      <Stars className="mb-1 me-1" /><span className="d-none d-sm-inline">Explorer</span>
                    </a>
                  </div>
                  {this.props.network && (
                    <>
  ...
  <div className="col-md-4 text-center">
    <a href="https://shido-observer.com" target="_blank" rel="noreferrer" className="text-reset text-decoration-none d-block mb-2">
      <span className="d-none d-sm-inline">Built with 💚&nbsp;</span> by SHIDO Observer
    </a>
    <span role="button" className="text-reset text-decoration-none">
      {this.props.theme === 'light' ? (
        <img src={Logo} srcSet={`${Logo2x} 2x, ${Logo3x} 3x`} alt="REStake" />
