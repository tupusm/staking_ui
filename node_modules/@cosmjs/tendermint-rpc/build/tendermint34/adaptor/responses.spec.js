...
describe("Adaptor Responses", () => {
    describe("decodeValidatorGenesis", () => {
        it("works for genesis format", () => {
            ...
            const validator = (0, responses_1.decodeValidatorGenesis)({
            ...
            expect(validator).toEqual({
                address: (0, encoding_1.fromHex)("A03DC128D38DB0BC5F18AE1872F1CB2E1FD41157"),
                votingPower: 169980,
                pubkey: {
                    algorithm: "ed25519",
                    data: (0, encoding_1.fromBase64)("2BX6Zuj8RmdJAkD1BAg6KB0v04liyM7jBdwOGIb9F9Q="),
                },
            });
        });
    });
    describe("decodeValidatorUpdate", () => {
        it("works for block results format", () => {
            ...
            const update = (0, responses_1.decodeValidatorUpdate)({
                pub_key: {
                    Sum: {
            ...
            expect(update).toEqual({
                pubkey: {
                    algorithm: "ed25519",
                    data: (0, encoding_1.fromBase64)("0kNlxBMpm+5WtfHIG1xsWatOXTKPLtmSqn3EiEIDZeI="),
                },
    ...
    describe("decodeValidatorInfo", () => {
        it("works for validators format", () => {
            ...
            const info = (0, responses_1.decodeValidatorInfo)({
            ...
            expect(info).toEqual({
                address: (0, encoding_1.fromHex)("AC2D56057CD84765E6FBE318979093E8E44AA18F"),
                pubkey: {
                    algorithm: "ed25519",
                    data: (0, encoding_1.fromBase64)("0kNlxBMpm+5WtfHIG1xsWatOXTKPLtmSqn3EiEIDZeI="),
                },
